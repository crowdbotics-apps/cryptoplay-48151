"""
Django settings for cryptoplay_48151 project.
...
ROOT_URLCONF = 'cryptoplay_48151.urls'
...
WSGI_APPLICATION = 'cryptoplay_48151.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cryptoplay_48151 API",
    "DESCRIPTION": "API documentation for cryptoplay_48151 App",
    "VERSION": "v1",
}
